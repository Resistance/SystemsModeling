...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5), null));
    ...
    status.setMaximumSize(new Dimension(660, 20));
    status.setOpaque(false);
    status.setPreferredSize(new Dimension(650, 20));
    ...
    b0.setText("0");
    b0.setToolTipText("Score of left player");
    ...
    a0.setText("0");
    a0.setToolTipText("Score of right player");
    ...
    right = new JLabel();
    right.setFont(new Font(right.getFont().getName(), right.getFont().getStyle(), 24));
    right.setText("Right Player");
    right.setToolTipText("Right player's name");
    panel7.add(right, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    panel8.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 2, 0), -1, -1));
    gbc = new GridBagConstraints();
    gbc.gridx = 0;
    gbc.gridy = 0;
    gbc.fill = GridBagConstraints.BOTH;
    ...
    left = new JLabel();
    left.setFont(new Font(left.getFont().getName(), left.getFont().getStyle(), 24));
    left.setText("Left Player");
    left.setToolTipText("Left player's name");
    panel8.add(left, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
